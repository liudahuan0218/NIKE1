...
movies_df.to_csv('movies.csv', index=False, header=True, encoding='utf-8')
# movies_df.tail()
...
ratings_df.to_csv('ratings.csv', index=False, header=True, encoding='utf-8')
# ratings_df.head()
...
#定义保存信息的路径
filename='C:\Users\南陌欢少\Desktop\python project\音乐推荐\movies_recommend_system-master\movie_tensorboard'

#把信息保存在文件当中
writer = tf.summary.FileWriter(r'C:\Users\南陌欢少\Desktop\python project\音乐推荐\movies_recommend_system-master\movie_tensorboard')
